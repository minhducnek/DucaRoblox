    ...
    spawn(function()
        pcall(function()
            while wait() do
                ...
                v485:SetDesc("Đang Có : " .. tostring(v768) .. " Xương");
            end
        end);
    end);
    ...
    while task.wait() do
        pcall(function()
            if _G.WalkonWater then
                game:GetService("Workspace").Map["WaterBase-Plane"].Size = Vector3.new(3000, 120, 3000);
            else
                game:GetService("Workspace").Map["WaterBase-Plane"].Size = Vector3.new(3000, 120, 3000);
            end
        end);
...
_G.SelectFruit = "Dragon (West)-Dragon (West)";
_G.PermanentFruit = "Dragon (West)-Dragon (West)";
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    ...
    Description = "Nếu Lỗi Tắt Bật Lại",
    Default = false
});
...
local v56 = v16.Misc:AddSection("Máy Chủ 2");
...
local v168 = v16.Sea:AddSection("Đảo Núi Lửa");
