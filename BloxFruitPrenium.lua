    ...
    while task.wait() do
        pcall(function()
            if _G.WalkonWater then
                game:GetService("Workspace").Map["WaterBase-Plane"].Size = Vector3.new(1500, 120, 1500);
            else
                game:GetService("Workspace").Map["WaterBase-Plane"].Size = Vector3.new(1500, 120, 1500);
            end
        end);
...
spawn(function()
    pcall(function()
        while wait() do
         ...
         if not _G.Random_Auto Mythical fruit or Legendary fruit then _G.Random_Auto to Mythical fruit or Legendary fruit else _G.Random_Auto to Mythical fruit or Legendary fruit;
            end
        end
    end);
end);
