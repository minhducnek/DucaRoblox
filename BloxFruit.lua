...
shared.LoaderTitle = "Đăng Ký Kênh Duca Roblox";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://96772127161592",
...
function AttackNoCoolDown()
    ...
    pcall(function()
        ...
        if (# v228 > 0) then
            v478:FireServer(1e-);
            v479:FireServer(v230, v228);
        else
            task.wait(1e-);
        end
    end);
end
Type = 1;
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=82937933007143";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "YouTube Của Duca",
    Description = "Bấm Để Sao Chép",
    Callback = function()
        setclipboard("https://youtube.com/@duca-roblox?si=UqyvK485lPNMywUM");
    end
});
        ...
        if _G.FastAttackStrix_Mode then
            pcall(function()
                if (_G.FastAttackStrix_Mode == "Super Fast Attack") then
                    _G.Fast_Delay = 1e-;
                end
            end);
        end
    end
        ...
        while wait() do
            pcall(function()
                if (game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban")) then
                    v529:SetDesc("Elite Boss: ✅️ | Đã Giết :  " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
                else
                    v529:SetDesc("Elite Boss: ❌️ | Đã Giết : " .. game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter", "Progress"));
                end
            end);
...
v17.ToggleF:SetValue(false);
local v99 = v16.Status:AddParagraph({
    Title = "Trạng Thái Người Chơi",
    ...
    while task.wait() do
        pcall(function()
            if _G.WalkonWater then
                game:GetService("Workspace").Map["WaterBase-Plane"].Size = Vector3.new(4000, 150, 4000);
            else
                game:GetService("Workspace").Map["WaterBase-Plane"].Size = Vector3.new(4000, 150, 4000);
            end
        end);
...
local v127 = v16.Fruit:AddToggle("ToggleRandomFruit", {
    Title = "Random Trái",
    Description = "( Đã Thêm Tỉ Lệ May Mắn )",
    Default = false
});
...
local v146 = v16.Race:AddToggle("ToggleKillTrial", {
    Title = "Giết Người Chơi Trong Trial",
    Description = "",
    Default = false
});
...
local v56 = v16.Misc:AddSection("Mã");
local v150 = {
    "KITT_RESET",
    "Sub2UncleKizaru",
...
local v169 = v16.Sea:AddParagraph({
    Title = "Trạng Thái Đảo Dung Nham ❌️",
    Content = ""
});
spawn(function()
    pcall(function()
