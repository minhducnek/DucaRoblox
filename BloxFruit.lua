...
function CheckLevel()
    ...
    if Sea3 then
        ...
        elseif ((v197 == 2575) or (v197 <= 2599) or (SelectMonster == "Skull Slayer") or (v197 == 2600)) then
            ...
            elseif ((v197 == 2600) or (v197 <= 2649) or (SelectMonster == "Skull Slayer") or (v197 == 2650)) then
            Ms = "Skull Slayer";
            NameQuest = "TikiQuest3";
            QuestLv = 2;
            NameMon = "Skull Slayer";
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=96772127161592";
v24.Parent = v23;
...
v16.Home:AddButton({
    Title = "Bản Quyền Thuộc Về Duca Roblox",
    Description = "",
    Callback = function()
        setclipboard("");
    end
...
if Sea3 then
    local v490 = v16.Main:AddSection("Tư Lệnh Bột");
            ...
            pcall(function()
                if _G.AutoStoreFruit then
                    ...
                    if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Blade Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Blade Fruit")) then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Blade-Blade", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Blade Fruit"));
                    end
                    ...
                    if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Eagle Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Eagle Fruit")) then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Eagle", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Eagle Fruit"));
                    end
                    ...
                    if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Creation Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Creation Fruit")) then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Creation-Creation", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Creation Fruit"));
                    end
                    ...
                    if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Gas Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Gas Fruit")) then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Gas-Gas", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Gas Fruit"));
                    end
                    if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Spirit Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Spirit Fruit")) then
                        ...
                        if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Leopard Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Leopard Fruit")) then
                            ...
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Yeti-Yeti", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Yeti Fruit"));
                            end
                            ...
                            if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon (East) Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon (East) Fruit")) then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Dragon (East)-Dragon (East)", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon (East) Fruit"));
                       end
                       if (game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon (West) Fruit") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon (West) Fruit")) then
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("StoreFruit", "Dragon (West)-Dragon (West)", game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon (West) Fruit"));
                        end
                    end
                end
            end);
...
local v140 = v16.Raid:AddToggle("ToggleNextIsland", {
    ...
    Description = "Lỗi Thì Tắt Bật Lại Nha",
    Default = false
});
...
local v56 = v16.Misc:AddSection("Máy Chủ Phụ");
local v151 = v16.Misc:AddToggle("ToggleRejoin", {
    Title = "Tham Gia Máy Chủ Lại",
    Description = "Dùng Khi Máy Chủ Kia Lỗi",
    Default = true
});
...
v16.Misc:AddButton({
    Title = "Xoá Sương Mù",
    Description = "Cần Khi Vào Đảo Bí Ẩn",
    Callback = function()
        v152();
    end
});
...
local v159 = v16.Sea:AddParagraph({
    Title = "Trạng Thái Nhiệm Vụ Cầu Lửa",
    Content = ""
});
spawn(function()
    pcall(function()
...
local v166 = v16.Sea:AddParagraph({
    Title = "Hoàn Thành Ải Draco V4 (Chưa Có)",
    Content = ""
});
