local gui = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/z4gs/scripts/master/testtttt.lua"))():AddWindow("Duca Roblox", {
...
tab4:AddSwitch("Auto add kagune", function(bool) array.weapon = bool end)
